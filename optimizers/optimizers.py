    ...
    def step(self) -> None:
        ...
        for att in attributes:
            ...
            if layer.has_parameters():
                ...
                # initialize previous first moments for the firt iteration
                ...
                for i, derivative in enumerate(derivatives):
                    ...
                    # update calculate moving avarages
...
class Adam(Optimizer):
    "Adam Optimizer"
    def __init__(self, model : object, learning_rate :float = 0.001, beta1 : float = 0.9, beta2 : float = 0.999, epsilon : float = 10e-8):
    ...
    def step(self):
        ...
        for att in attributes:
            ...
            if layer.has_parameters():
                ...
                # initialize previous first and second moments for the firt iteration
